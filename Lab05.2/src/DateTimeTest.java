...
class DateTimeTest {
  ...
  public static void testNow() {
    ...
    LocalDate Yo = LocalDate.now();
    System.out.println(Yo);
    LocalDateTime Yot = LocalDateTime.now();
  ...
  public static void testCreate() {
    ...
    LocalDateTime lunarlanding = LocalDateTime.of(1984, 01, 01, 23, 5);
  ...
  public static void testParse() {
    LocalDate birthday = LocalDate.parse("1984-1-01");
    System.out.println(birthday);

    DateTimeFormatter formatter = DateTimeFormatter.ofPattern("M/d/yyyy");
    birthday = LocalDate.parse("01/01/1984 , formatter");
    System.out.println(birthday);
