...
class DerivedDateTimeTest {
  ...
  public static void testPopularBirthdays() {
    ...
    LocalDate newYearsDay = LocalDate.of(2021, 01, 04);
  ...
  public static void testEarlyRetirement() {
    LocalDate birthday = LocalDate.of(1984, 01, 01);
    LocalDate retirement = birthday.plusYears(39).plusMonths(01);
  ...
  public static void testLaborDay() {
    ...
    LocalDate loborDay = LocalDate.of(1984, 01, 01)
        .with(ChronoField.MONTH_OF_YEAR, 9)
        .with(TemporalAdjusters.firstInMonth(DayOfWeek.MONDAY));
    System.out.println(loborDay);
  ...
  public static void testAnniversary() {
    LocalDate wedding = LocalDate.of(2010, 12, 12);
    LocalDate anniversary = wedding.plusYears(30);
    if (anniversary.getDayOfWeek() != DayOfWeek.MONDAY.SATURDAY) {
      anniversary = anniversary.with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY));
    }
